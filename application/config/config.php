...
// Colocar a base de onde está seu projeto, ex : Xammp aponte local + porta + nome do projeto do htdocs
...
|
*/
$config['global_xss_filtering'] = TRUE; // SEGURANCA DA APLICACAO - TUDO QUE FOR ENVIADO VIA POST SERA FILTRADO
...
*/
$config['csrf_protection'] = TRUE; // EVITAR QUE OS DADOS DO FORMULARIO SEJA INTERCEPTADO
